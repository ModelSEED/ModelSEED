...
$objectDefinitions->{FBAFormulation} = {
	...
	attributes => [
		...
		{name => 'findMinimalMedia',printOrder => 13,perm => 'rw',type => 'Bool',default => 0},
		{name => 'notes',printOrder => -1,perm => 'rw',type => 'Str',req => 0,default => ""},
		{name => 'expressionData_uuid',printOrder => -1,perm => 'rw',type => 'ModelSEED::uuid',req => 0},
		{name => 'objectiveConstraintFraction',printOrder => 0,perm => 'rw',type => 'ModelSEED::varchar',req => 0,default => "none"},
		{name => 'allReversible',printOrder => 14,perm => 'rw',type => 'Int',len => 255,req => 0,default => "0"},
		{name => 'defaultMaxFlux',printOrder => 20,perm => 'rw',type => 'Int',req => 1,default => 1000},
		{name => 'defaultMaxDrainFlux',printOrder => 22,perm => 'rw',type => 'Int',req => 1,default => 1000},
		{name => 'defaultMinDrainFlux',printOrder => 21,perm => 'rw',type => 'Int',req => 1,default => -1000},
		{name => 'maximizeObjective',printOrder => -1,perm => 'rw',type => 'Bool',req => 1,default => 1},		
		{name => 'decomposeReversibleFlux',printOrder => -1,perm => 'rw',type => 'Bool',len => 32,req => 0,default => 0},
		{name => 'decomposeReversibleDrainFlux',printOrder => -1,perm => 'rw',type => 'Bool',len => 32,req => 0,default => 0},
		{name => 'fluxUseVariables',printOrder => -1,perm => 'rw',type => 'Bool',len => 32,req => 0,default => 0},
		{name => 'drainfluxUseVariables',printOrder => -1,perm => 'rw',type => 'Bool',len => 32,req => 0,default => 0},
		{name => 'geneKO_uuids',printOrder => -1,perm => 'rw',type => 'ArrayRef',req => 0,default => "sub{return [];}"},
		{name => 'reactionKO_uuids',printOrder => -1,perm => 'rw',type => 'ArrayRef',req => 0,default => "sub{return [];}"},
		{name => 'parameters',printOrder => -1,perm => 'rw',type => 'HashRef',req => 0,default => "sub{return {};}"},
		{name => 'uptakeLimits',printOrder => -1,perm => 'rw',type => 'HashRef',req => 0,default => "sub{return {};}"},
		{name => 'numberOfSolutions',printOrder => 23,perm => 'rw',type => 'Int',req => 0,default => 1},
		{name => 'simpleThermoConstraints',printOrder => 15,perm => 'rw',type => 'Bool',req => 0,default => 1},
	...
	subobjects => [
		...
		{name => "fbaConstraints",printOrder => 1,class => "FBAConstraint",type => "encompassed"},
		{name => "fbaReactionBounds",printOrder => 2,class => "FBAReactionBound",type => "encompassed"},
		{name => "fbaCompoundBounds",printOrder => 3,class => "FBACompoundBound",type => "encompassed"},
		{name => "fbaResults",printOrder => 5,class => "FBAResult",type => "result"},
		{name => "fbaPhenotypeSimulations",printOrder => 4,class => "FBAPhenotypeSimulation",type => "encompassed"},
	],
	primarykeys => [ qw(uuid) ],
	links => [
...
$objectDefinitions->{FBAConstraint} = {
	...
	class => 'encompassed',
	attributes => [
		{name => 'name',printOrder => -1,perm => 'rw',type => 'Str',req => 0,default => "0"},
		{name => 'rhs',printOrder => -1,perm => 'rw',type => 'Num',req => 0,default => "0"},
		{name => 'sign',printOrder => -1,perm => 'rw',type => 'Str',req => 0,default => "0"}
	],
	subobjects => [
		{name => "fbaConstraintVariables",printOrder => -1,class => "FBAConstraintVariable",type => "encompassed"},
	],
	primarykeys => [ qw(atom) ],
	links => []
};
...
$objectDefinitions->{FBAConstraintVariable} = {
	...
	class => 'encompassed',
	attributes => [
		{name => 'entity_uuid',printOrder => -1,perm => 'rw',type => 'ModelSEED::uuid',len => 1,req => 0},
		{name => 'entityType',printOrder => -1,perm => 'rw',type => 'Str',req => 1},
		{name => 'variableType',printOrder => -1,perm => 'rw',type => 'Str',req => 1},
		{name => 'coefficient',printOrder => -1,perm => 'rw',type => 'Num',len => 1,req => 0},
	],
	subobjects => [],
	primarykeys => [ qw(atom) ],
	links => []
...
$objectDefinitions->{FBAReactionBound} = {
	...
	class => 'encompassed',
	attributes => [
		{name => 'modelreaction_uuid',printOrder => -1,perm => 'rw',type => 'ModelSEED::uuid',req => 1},
		{name => 'variableType',printOrder => -1,perm => 'rw',type => 'Str',req => 1},
		{name => 'upperBound',printOrder => -1,perm => 'rw',type => 'Num',req => 1},
		{name => 'lowerBound',printOrder => -1,perm => 'rw',type => 'Num',req => 1},
	],
	subobjects => [],
...
$objectDefinitions->{FBACompoundBound} = {
	...
	class => 'encompassed',
	attributes => [
		{name => 'modelcompound_uuid',printOrder => -1,perm => 'rw',type => 'ModelSEED::uuid',req => 1},
		{name => 'variableType',printOrder => -1,perm => 'rw',type => 'Str',req => 1},
		{name => 'upperBound',printOrder => -1,perm => 'rw',type => 'Num',req => 1},
		{name => 'lowerBound',printOrder => -1,perm => 'rw',type => 'Num',req => 1},
	],
...
$objectDefinitions->{FBAResult} = {
	...
	attributes => [
		...
		{name => 'modDate',printOrder => -1,perm => 'rw',type => 'Str',req => 0},
		{name => 'notes',printOrder => 1,perm => 'rw',type => 'Str',req => 0,default => ""},
		{name => 'objectiveValue',printOrder => -1,perm => 'rw',type => 'Num',req => 0},
	],
	subobjects => [
		{name => "fbaCompoundVariables",printOrder => 2,class => "FBACompoundVariable",type => "encompassed"},
		{name => "fbaReactionVariables",printOrder => 3,class => "FBAReactionVariable",type => "encompassed"},
		{name => "fbaBiomassVariables",printOrder => 1,class => "FBABiomassVariable",type => "encompassed"},
		{name => "fbaPhenotypeSimultationResults",printOrder => 6,class => "FBAPhenotypeSimultationResult",type => "encompassed"},
		{name => "fbaDeletionResults",printOrder => 4,class => "FBADeletionResult",type => "encompassed"},
		{name => "minimalMediaResults",printOrder => 5,class => "FBAMinimalMediaResult",type => "encompassed"},
...
$objectDefinitions->{FBACompoundVariable} = {
	...
	attributes => [
		...
		{name => 'class',printOrder => 9,perm => 'rw',type => 'Str',req => 0},
		{name => 'lowerBound',printOrder => 4,perm => 'rw',type => 'Num',len => 1,req => 0},
		{name => 'upperBound',printOrder => 5,perm => 'rw',type => 'Num',len => 1,req => 0},
		{name => 'min',printOrder => 7,perm => 'rw',type => 'Num',len => 1,req => 0},
		{name => 'max',printOrder => 8,perm => 'rw',type => 'Num',len => 1,req => 0},
		{name => 'value',printOrder => 6,perm => 'rw',type => 'Num',len => 1,req => 0},
	],	
	subobjects => [],
	primarykeys => [ qw() ],
	links => [
...
$objectDefinitions->{FBABiomassVariable} = {
	...
	class => 'encompassed',
	attributes => [
		{name => 'biomass_uuid',printOrder => -1,perm => 'rw',type => 'ModelSEED::uuid',req => 1},
...
$objectDefinitions->{FBAPhenotypeSimultationResult} = {
	...
	class => 'encompassed',
	attributes => [
		{name => 'simulatedGrowthFraction',printOrder => 3,perm => 'rw',type => 'Num',req => 1},
		{name => 'simulatedGrowth',printOrder => 4,perm => 'rw',type => 'Num',req => 1},
		{name => 'class',printOrder => 5,perm => 'rw',type => 'Str',len => 1,req => 1},
		{name => 'noGrowthCompounds',printOrder => -1,perm => 'rw',type => 'ArrayRef',req => 0,default => "sub{return [];}"},
		{name => 'dependantReactions',printOrder => -1,perm => 'rw',type => 'ArrayRef',req => 0,default => "sub{return [];}"},
		{name => 'dependantGenes',printOrder => -1,perm => 'rw',type => 'ArrayRef',req => 0,default => "sub{return [];}"},
		{name => 'fluxes',printOrder => -1,perm => 'rw',type => 'HashRef',req => 0,default => "sub{return {};}"},
		{name => 'fbaPhenotypeSimulation_uuid',printOrder => -1,perm => 'rw',type => 'ModelSEED::uuid',req => 1},
	],	
	subobjects => [],
...
$objectDefinitions->{FBADeletionResult} = {
	...
	class => 'encompassed',
	attributes => [
		{name => 'geneko_uuids',printOrder => -1,perm => 'rw',type => 'ArrayRef',req => 1},
		{name => 'growthFraction',printOrder => 1,perm => 'rw',type => 'Num',req => 1},
	],	
	subobjects => [],
...
$objectDefinitions->{FBAMinimalMediaResult} = {
	...
	class => 'encompassed',
	attributes => [
		{name => 'minimalMedia_uuid',printOrder => -1,perm => 'rw',type => 'ModelSEED::uuid',req => 1},
		{name => 'essentialNutrient_uuids',printOrder => -1,perm => 'rw',type => 'ArrayRef',req => 1},
		{name => 'optionalNutrient_uuids',printOrder => -1,perm => 'rw',type => 'ArrayRef',req => 1},
	],	
	subobjects => [],
...
$objectDefinitions->{FBAMetaboliteProductionResult} = {
	...
	attributes => [
		{name => 'modelCompound_uuid',printOrder => -1,perm => 'rw',type => 'ModelSEED::uuid',req => 1},
		{name => 'maximumProduction',printOrder => 3,perm => 'rw',type => 'Num',req => 1},
	],	
	subobjects => [],
	primarykeys => [ qw(minimalMedia_uuid) ],
	links => [
